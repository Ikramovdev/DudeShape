    ...
    <section className='mb-[140px]'>
        <div className='container'>
            <div className='flex flex-col-reverse lg:flex-row bg-[#154444]'>
                ...
                <div className='flex flex-col pt-[100px] pl-[24px] lg:pl-[100px]'>
                    <h1 className='w-[380px] lg:w-[671px] font-bold text-[32px] lg:text-[56px] leading-[42px] lg:leading-[68px] text-white mb-[12px] lg:mb-5'>We Help You Make Modern Furniture</h1>
                    ...
                    <button className='w-[172px] py-[15px] text-center bg-white text-regular text-[20px] leading-[25px] text-[#154444]'>Explore More</button>
                </div>
            </div>
        </div>
    </section>
